...
const arrBenPrimeAfAliens = [
    ...
    {nomePtbr: 'Arraia Jato', nomeIngles: 'Jetray', seasonName: 'primeBenAfJetRay', wikiUrl: 'Jetray_(Classic)', imgAf: ['./assets/img/aliens/ben-prime/af/arraia-jato-(af)-1.png', './assets/img/aliens/ben-prime/af/arraia-jato-(af)-2.png', './assets/img/aliens/ben-prime/af/arraia-jato-(af)-3.png', './assets/img/aliens/ben-prime/af/arraia-jato-(af)-4.png', './assets/img/aliens/ben-prime/af/arraia-jato-(af)-5.png']},

    {nomePtbr: 'Artrópode', nomeIngles: 'Brainstorm', seasonName: 'primeBenAfBrainStorm', wikiUrl: 'Brainstorm', imgAf: ['./assets/img/aliens/ben-prime/af/artropode-(af)-1.png', './assets/img/aliens/ben-prime/af/artropode-(af)-2.png', './assets/img/aliens/ben-prime/af/artropode-(af)-3.png', './assets/img/aliens/ben-prime/af/artropode-(af)-4.png', './assets/img/aliens/ben-prime/af/artropode-(af)-5.png']},

    {nomePtbr: 'Bebê Necrofriggiano', nomeIngles: "Big Chill's Offspring", seasonName: 'primeBenAfBigChillBaby', wikiUrl: 'Big_Chill%27s_Offspring', imgAf: ['./assets/img/aliens/ben-prime/af/bebe-necrofrigiano-(af)-1.png', './assets/img/aliens/ben-prime/af/bebe-necrofrigiano-(af)-2.png', './assets/img/aliens/ben-prime/af/bebe-necrofrigiano-(af)-3.jpg', './assets/img/aliens/ben-prime/af/bebe-necrofrigiano-(af)-4.jpg', './assets/img/aliens/ben-prime/af/bebe-necrofrigiano-(af)-5.jpg', './assets/img/aliens/ben-prime/af/bebe-necrofrigiano-(af)-6.jpg']},
...
const arrBenPrimeUaAliens = [
    ...
    {nomePtbr: 'Contratempo', nomeIngles: "Clockwork", seasonName: 'primeBenUaClockwork', wikiUrl: 'Clockwork', imgUa: ['./assets/img/aliens/ben-prime/ua/contra-tempo-(ua)-1.png', './assets/img/aliens/ben-prime/ua/contra-tempo-(ua)-2.jpg']},
...
const arrBenPrimeUaClassicAliens = [
        ...
        for(let i = 0; i < arrBenPrimeUaAliens.length; i++){
            ...
            var uaAliens = document.getElementById("ua-cards").innerHTML += `
                <li class="alien-card ${arrBenPrimeUaAliens[i].seasonName}">
                    ...
                    <div class="alien-card-description">
                        <a href="https://ben10.fandom.com/wiki/${arrBenPrimeUaAliens[i].wikiUrl}" target="_blank">
                            <p>${arrBenPrimeUaAliens[i].nomePtbr}</p>
                        </a>
                    </div>
        ...
        for(let i = 0; i < arrBenPrimeUaUltimateAliens.length; i++){
            ...
            var uaUltimateAliens = document.getElementById("ua-ultimate-cards").innerHTML += `
                <li class="alien-card ${arrBenPrimeUaUltimateAliens[i].seasonName}">
                    ...
                    <div class="alien-card-description">
                        <a href="https://ben10.fandom.com/wiki/${arrBenPrimeUaUltimateAliens[i].wikiUrl}" target="_blank">
                            <p>${arrBenPrimeUaUltimateAliens[i].nomePtbr}</p>
                        </a>
                    </div>
        ...
        for(let i = 0; i < arrBenPrimeUaClassicAliens.length; i++){
            ...
            var uaClassicAliens = document.getElementById("ua-os-cards").innerHTML += `
                <li class="alien-card ${arrBenPrimeUaClassicAliens[i].seasonName}">
                    ...
                    <div class="alien-card-description">
                        <a href="https://ben10.fandom.com/wiki/${arrBenPrimeUaClassicAliens[i].wikiUrl}" target="_blank">
                            <p>${arrBenPrimeUaClassicAliens[i].nomePtbr}</p>
                        </a>
                    </div>
...
const arrBenPrimeOvAliens = [
    ...
    {nomePtbr: 'Bigotóide', nomeIngles: "Mole-Stache", seasonName: 'primeBenOvMole-Stache', wikiUrl: 'Mole-Stache', imgOv: ['./assets/img/aliens/ben-prime/omniverse/bigotoide-(omniverse)-1.png', './assets/img/aliens/ben-prime/omniverse/bigotoide-(omniverse)-2.png', './assets/img/aliens/ben-prime/omniverse/bigotoide-(omniverse)-3.png']},

    {nomePtbr: 'Bloxx', nomeIngles: "Bloxx", seasonName: 'primeBenOvBloxx', wikiUrl: 'Bloxx_(Classic)', imgOv: ['./assets/img/aliens/ben-prime/omniverse/bloxx-(omniverse)-1.png', './assets/img/aliens/ben-prime/omniverse/bloxx-(omniverse)-2.png', './assets/img/aliens/ben-prime/omniverse/bloxx-(omniverse)-3.png', './assets/img/aliens/ben-prime/omniverse/bloxx-(omniverse)-4.png', './assets/img/aliens/ben-prime/omniverse/bloxx-(omniverse)-5.png', './assets/img/aliens/ben-prime/omniverse/bloxx-(omniverse)-6.png',]}, 
    
    {nomePtbr: 'Bullfrag', nomeIngles: "Bullfrag", seasonName: 'primeBenOvBullfrag', wikiUrl: 'Bullfrag', imgOv: ['./assets/img/aliens/ben-prime/omniverse/bullfrag-(omniverse)-1.png', './assets/img/aliens/ben-prime/omniverse/bullfrag-(omniverse)-2.png', './assets/img/aliens/ben-prime/omniverse/bullfrag-(omniverse)-3.png', './assets/img/aliens/ben-prime/omniverse/bullfrag-(omniverse)-4.png', './assets/img/aliens/ben-prime/omniverse/bullfrag-(omniverse)-5.png', './assets/img/aliens/ben-prime/omniverse/bullfrag-(omniverse)-6.png', './assets/img/aliens/ben-prime/omniverse/bullfrag-(omniverse)-7.png']},

    {nomePtbr: 'Cocorocóide', nomeIngles: "Kickin Hawk", seasonName: 'primeBenOvKickinHawk', wikiUrl: 'Kickin_Hawk', imgOv: ['./assets/img/aliens/ben-prime/omniverse/cocorocoide-(omniverse)-1.png', './assets/img/aliens/ben-prime/omniverse/cocorocoide-(omniverse)-2.png', './assets/img/aliens/ben-prime/omniverse/cocorocoide-(omniverse)-3.png', './assets/img/aliens/ben-prime/omniverse/cocorocoide-(omniverse)-4.png']},

    {nomePtbr: 'Crashhopper', nomeIngles: "Crashhopper", seasonName: 'primeBenOvCrashhopper', wikiUrl: 'Crashhopper', imgOv: ['./assets/img/aliens/ben-prime/omniverse/crashhopper-(omniverse)-1.png', './assets/img/aliens/ben-prime/omniverse/crashhopper-(omniverse)-2.png', './assets/img/aliens/ben-prime/omniverse/crashhopper-(omniverse)-3.png', './assets/img/aliens/ben-prime/omniverse/crashhopper-(omniverse)-4.png', './assets/img/aliens/ben-prime/omniverse/crashhopper-(omniverse)-5.png']},

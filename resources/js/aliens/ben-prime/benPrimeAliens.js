...
const arrBenPrimeClassicAliens = [
    ...
    {nomePtbr: 'Besta', nomeIngles: "Wildmutt", seasonName: 'primeBenOsWildMutt', wikiUrl: 'https://ben10.fandom.com/wiki/Wildmutt', imgOs: ['./assets/img/aliens/ben-prime/classico/besta-(classico)-1.png', './assets/img/aliens/ben-prime/classico/besta-(classico)-2.png', './assets/img/aliens/ben-prime/classico/besta-(classico)-3.png', './assets/img/aliens/ben-prime/classico/besta-(classico)-4.png', './assets/img/aliens/ben-prime/classico/besta-(classico)-5.png', './assets/img/aliens/ben-prime/classico/besta-(classico)-6.png']},
    ...
    {nomePtbr: 'Cipó Selvagem', nomeIngles: "Wildvine", seasonName: 'primeBenOsWildvine', wikiUrl: 'https://ben10.fandom.com/wiki/Wildvine_(Classic)', imgOs: ['./assets/img/aliens/ben-prime/classico/cipo-selvagem-(classico)-1.png', './assets/img/aliens/ben-prime/classico/cipo-selvagem-(classico)-2.png']},
    ...
    {nomePtbr: 'Fantasmático', nomeIngles: "Ghostfreak", seasonName: 'primeBenOsGhostFreak', wikiUrl: 'https://ben10.fandom.com/wiki/Ghostfreak', imgOs: ['./assets/img/aliens/ben-prime/classico/fantasmatico-(classico)-1.png', './assets/img/aliens/ben-prime/classico/fantasmatico-(classico)-2.png', './assets/img/aliens/ben-prime/classico/fantasmatico-(classico)-3.png', './assets/img/aliens/ben-prime/classico/fantasmatico-(classico)-4.png', './assets/img/aliens/ben-prime/classico/fantasmatico-(classico)-5.png', './assets/img/aliens/ben-prime/classico/fantasmatico-(classico)-6.jpg']},
...
const arrBenPrimeUaAliens = [
    ...
    {nomePtbr: 'Ameaça Aquática', nomeIngles: "Water Hazard", seasonName: 'primeBenUaWaterHazard', wikiUrl: 'Water_Hazard', imgUa: ['./assets/img/aliens/ben-prime/ua/ameaca-aquatica-(ua)-1.png', './assets/img/aliens/ben-prime/ua/ameaca-aquatica-(ua)-2.png', './assets/img/aliens/ben-prime/ua/ameaca-aquatica-(ua)-3.png']},
    ...
    {nomePtbr: 'Contratempo', nomeIngles: "Clockwork", seasonName: 'primeBenUaClockwork', wikiUrl: 'Clockwork', imgUa: ['./assets/img/aliens/ben-prime/ua/contra-tempo-(ua)-1.png', './assets/img/aliens/ben-prime/ua/contra-tempo-(ua)-2.png']},
        ...
        for(let i = 0; i < arrBenPrimeUaAliens.length; i++){
            ...
            var uaAliens = document.getElementById("ua-cards").innerHTML += `
                <li class="alien-card ${arrBenPrimeUaAliens[i].seasonName}">
                        ...
                        <div class="alien-card-img">
                            <img src="${arrBenPrimeUaAliens[i].imgUa[0]}" alt="${arrBenPrimeUaAliens[i].nomePtbr}" data-toggle="modal" data-target="#${arrBenPrimeUaAliens[i].seasonName}Modal">
                        </div>
        ...
        for(let i = 0; i < arrBenPrimeUaUltimateAliens.length; i++){
            ...
            var uaUltimateAliens = document.getElementById("ua-ultimate-cards").innerHTML += `
                <li class="alien-card ${arrBenPrimeUaUltimateAliens[i].seasonName}">
                    ...
                    <div class="alien-card-img">
                        <img src="${arrBenPrimeUaUltimateAliens[i].imgUa[0]}" alt="${arrBenPrimeUaUltimateAliens[i].nomePtbr}" data-toggle="modal" data-target="#${arrBenPrimeUaUltimateAliens[i].seasonName}Modal">
                    </div>
        ...
        for(let i = 0; i < arrBenPrimeUaClassicAliens.length; i++){
            ...
            var uaClassicAliens = document.getElementById("ua-os-cards").innerHTML += `
                <li class="alien-card ${arrBenPrimeUaClassicAliens[i].seasonName}">
                    ...
                    <div class="alien-card-img">
                        <img src="${arrBenPrimeUaClassicAliens[i].imgUaClassic[0]}" alt="${arrBenPrimeUaClassicAliens[i].nomePtbr}" data-toggle="modal" data-target="#${arrBenPrimeUaClassicAliens[i].seasonName}Modal">
                    </div>
